...
En la carpeta `data/processed` del repositorio se alojan los master_data_sets utilizados para las visualizaciones y del agrupamiento por clusters, ejecutado mediante el algoritmo K-means de ML no supervisado.
